	...
	public void onEntitySpawn(EntityJoinWorldEvent event)
	{
		...
		{			
			if (!event.entity.worldObj.isRemote)
			{
				...
				{
					if (entity.getEntityAttribute(SharedMonsterAttributes.maxHealth).getModifier(UUID.fromString("a700a0e4-b79a-44b6-a752-a94778bc62b3")) == null && entity.getEntityAttribute(SharedMonsterAttributes.attackDamage).getModifier(UUID.fromString("3cdd6b08-ae6f-47e9-aff1-b7bdddb99511")) == null)
					{
				...
				{
					if (entity.getEntityAttribute(SharedMonsterAttributes.maxHealth).getModifier(UUID.fromString("e787da96-9f24-4c45-9175-b004c1b10111")) == null)					
					{
				...
				{
					if (entity.getEntityAttribute(SharedMonsterAttributes.maxHealth).getModifier(UUID.fromString("d0ffbfdb-10b4-444f-a613-e1d2d5598dee")) == null && entity.getEntityAttribute(SharedMonsterAttributes.attackDamage).getModifier(UUID.fromString("8f21e85f-bfed-4bdb-acf5-31562e5229d7")) == null)
					{
				...
				{
					if (entity.getEntityAttribute(SharedMonsterAttributes.maxHealth).getModifier(UUID.fromString("92b9eb29-304f-4e6b-90fd-55ccffe7a40b")) == null && entity.getEntityAttribute(SharedMonsterAttributes.attackDamage).getModifier(UUID.fromString("a7f4074f-51a4-472d-afc2-2586efeb2041")) == null)
					{
				...
				{
					if (entity.getEntityAttribute(SharedMonsterAttributes.maxHealth).getModifier(UUID.fromString("5dd6888e-0a54-424f-a4ec-71dd1a92fd89")) == null && entity.getEntityAttribute(SharedMonsterAttributes.attackDamage).getModifier(UUID.fromString("644515b8-d3c4-4342-a9f6-7e777bbded6f")) == null)
					{
